...
<footer class="saintsmedia-theme-footer" role="contentinfo">
	...
	<div class="footer-inner">
		...
		<div class="footer-contact">
			...
			$about_us = get_theme_mod('footer_contact_us');
			?>
			<a href="mailto:<?php echo esc_html(get_theme_mod('footer_mail_link')); ?>" class="footer-contact-link"><?php echo esc_html($about_us ? $about_us : 'Contact'); ?>:
				<?php
				$domain = wp_parse_url(home_url(), PHP_URL_HOST);
