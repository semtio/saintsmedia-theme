    ...
    <header class="saintsmedia-theme-header">
        ...
        <div class="saintsmedia-theme-cta menu-nav-buttons--desktop">
            <a target="_blank" href="<?php echo esc_url(tfc_go_link($link_btn_menu_1)); ?>">
                <button tabindex="0" class="sm-m-button sm-m-gradient-border sm-m-button--outline sm-m-button--secondary sm-m-button--s sm-m-button--wow">
                    <div class="sm-m-button-content"><?php echo esc_html($btn_menu_1); ?></div>
                </button>
            </a>

            <a target="_blank" href="<?php echo esc_url(tfc_go_link($link_btn_menu_2)); ?>">
                <button tabindex="0" class="sm-m-button sm-m-gradient-border sm-m-button--primary sm-m-button--s sm-m-button--wow">
                    <div class="sm-m-button-content"><span><?php echo esc_html($btn_menu_2); ?></span></div>
                </button>
            </a>
        </div>
